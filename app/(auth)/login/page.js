    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg)] p-4">
      ...
      <div className="w-full max-w-[400px] relative">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-gradient-to-br from-[var(--color-accent)] to-[var(--color-primary-hover)] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-[var(--color-accent)]/20">
            <Building2 size={28} className="text-white" />
          </div>
          <h1 className="text-xl font-bold text-[var(--color-text-secondary)] tracking-tight">APEX PLUMBING</h1>
          <p className="text-xs text-[var(--color-text-muted)] mt-1">Business Management System</p>
        </div>

        {/* Login Card */}
        <div className="bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] shadow-lg shadow-black/30 p-8">
          <h2 className="text-lg font-semibold text-[var(--color-text-secondary)] mb-1">Welcome back</h2>
          <p className="text-xs text-[var(--color-text-muted)] mb-6">Sign in to continue to dashboard</p>
