...
const Input = React.forwardRef(({ className, type, ...props }, ref) => {
  return (
    <input
      type={type}
      className={cn(
        "flex h-11 w-full rounded-lg border border-[var(--color-border)] bg-white px-3.5 py-2.5 text-base text-[var(--color-navy)] placeholder:text-[var(--color-body-light)] transition-all duration-150",
